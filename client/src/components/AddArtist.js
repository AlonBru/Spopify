...
function AddArtist({ sendData, sendStatus }) {
  ...
  return (
    ...
    >
      <input type="reset" htmlFor="form" />
      {' '}
      <br />
      <label htmlFor="name">
        artist name*:
        <input required name="name" placeholder="artist name" onChange={inputChange} />
        {' '}
        <br />
      </label>
      <label htmlFor="img">
        image:
        <input name="img" placeholder="image url" onChange={inputChange} />
        <br />
      </label>
      <label htmlFor="active_since">
        active since*:
